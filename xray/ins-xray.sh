...
wget -q -O /etc/nginx/conf.d/vps.conf "https://sc2.scvps.biz.id/JB3/vps.conf.txt"
sleep 1
wget -q -O xraymode.sh https://sc2.scvps.biz.id/JB3/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1 
wget -q -O /etc/xray/config.json "https://sc2.scvps.biz.id/JB3/config.json"
chmod +x /etc/xray/config.json
sleep 1 
rm -f /etc/nginx/conf.d/xray.conf
wget -q -O /etc/nginx/conf.d/xray.conf "https://sc2.scvps.biz.id/JB3/xray.conf"
