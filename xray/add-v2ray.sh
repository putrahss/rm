...
# //====================================================
# // font color configuration | PAPADA'AN STORE
...
EOF`
cat >/etc/julak/public_html/vmess-$user.txt <<-END
====================================================================
             P R O J E C T  O F J U L A K  B A N T U R
                       [Freedom Internet]
====================================================================
        https://github.com/Julak-Bantur/sc3
====================================================================
              Format Vmess WS (CDN)
====================================================================

- name: Julak-Bantur-Vmess-$user-WS (CDN)
  type: vmess
  server: ${domain}
  port: 443
  uuid: ${uuid}
...
- name: Julak-Bantur-$user-WS (CDN) Non TLS
  type: vmess
  server: ${domain}
  port: 80
  uuid: ${uuid}
