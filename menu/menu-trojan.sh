...
trojanlink="trojan://${uuid}@${domain}:443?path=%2Fwhatever%2Ftrojan-ws&security=tls&host=${domain}&type=ws&sni=${domain}#${user}"
...
echo -e "$COLOR1 ${NC} ${WH}Path WS        ${COLOR1}: ${WH}/whatever/trojan-ws" | tee -a /etc/log-create-user.log
